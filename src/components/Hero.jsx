...
function Hero() {
  return (
    <div>
      <section className="relative bg-gradient-to-br from-slate-50 to-white flex items-center overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-lg sm:text-xl text-gray-600 leading-relaxed max-w-xl">
                  Explore thousands of job opportunities and take the next step
                  in your career. Discover roles tailored to your skills and
                  ambitions.
                </p>
              </div>
            ...
            <div className="relative lg:justify-self-end">
              <div className="relative">
                ...
                {/* Floating icons */}
                <div className="absolute -top-8 -left-8 w-16 h-16 bg-white shadow-lg rounded-full flex items-center justify-center animate-bounce">
                  💼
                </div>
                <div className="absolute bottom-10 -right-8 w-16 h-16 bg-white shadow-lg rounded-full flex items-center justify-center animate-pulse">
                  🚀
                </div>
              </div>
            </div>
